/*import {Comment, Item, Shoppinglist} from './shoppinglist';
   ...
   static fromObject(rawShoppinglist: any): Shoppinglist {
       return new Shoppinglist(
           ...
           rawShoppinglist.comments,
               ...
               rawShoppinglist.authors,
                typeof (rawShoppinglist.published) === 'string' ?
                    new Date (rawShoppinglist.published) : rawShoppinglist.published,
...
export class ShoppinglistFactory {
    ...
    static fromObject(rawShoppinglist: any): Shoppinglist {
        return new Shoppinglist(
            ...
            rawShoppinglist.name,
          //  typeof (rawShoppinglist.due_date) == 'string' ?
            //    new Date(rawShoppinglist.due_date) :
